    ...
    if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
       ...
       // $_SESSION['sessCustomerID'] = $_SESSION["id"];
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if(empty($nombre_err) && empty($apellido_err) && empty($email_err) && empty($direccion_err) && empty($telefono_err)) {
                //$sql = "SELECT * FROM usuarios WHERE id NOT LIKE ('". $_SESSION['sessCustomerID'] ."')";
                //while($row = $sql->fetch_assoc()) {
                    $sql = "INSERT INTO usuarios_sr (id, nombre, apellido, email, direccion, telefono) VALUES (?, ?, ?, ?, ?, ?)";
...
<body>
    <main class="contenedor sombra">
        <a class="titulos-body alt3">Envío</a>
        <div class="checkout">
        <a class="titulos-body alt2">Datos para el envío</a>
            ...
            ?>
                ...
                <div class="center-sh">
                    ...
                    <div>
                        <input class="input-ship" name="nombre" value="<?php echo $nombre ?>" type="text" placeholder="Otilia" />
                    </div>
                    <br>
                    <label>Apellido:</label><br>
                    <div>
                        <input class="input-ship" name="apellido" value="<?php echo $apellido ?>" type="text" placeholder="Grijalva Pérez" />
                    </div>
                    <br>
                    <label>Dirección:</label><br>
                    <div>
                        <input class="input-ship" name="direccion" value="<?php echo $direccion ?>" type="text" placeholder="Urión XX, Col. Atlatilco, C.P. 02860" />
                    </div>
                    <br>
                    <label>Correo electrónico:</label><br>
                    <div>
                        <input class="input-ship" name="email" value="<?php echo $email ?>" type="email" placeholder="ejemplo@bandup.mx" />
                    </div>
                    <br>
                    <label>Teléfono:</label><br>
                    <div>
                        <input class="input-ship" name="telefono" value="<?php echo $telefono ?>" type="text" placeholder="222 123 4567" />
                    </div>
                    <br>
                        <button class="checkoutBtn shipBtn">Realizar pedido</button>
                    <br>
                </div>
            </form>
        </div>
        ...
        <div class="sub resp">
            <a class="subtotal">Subtotal</a><a class="subtotal precioSub"><?php echo $s.' MX$'.$cart->total() ?></a><br>
            ...
            <a>Estado</a><a class="subtotal precioSub">Pagado</a>
        </div>
