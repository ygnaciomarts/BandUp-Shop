                ...
                ?>
                        <div class="img-producto">
                            ...
                            <div class="contenido-producto">
                                    <a class="titulos-producto c"><?php echo str_replace("`", "'", $nombre)?></a>
                                    ...
                                    <br>
                                    <a class="titulos-producto info top listado">
                                        Tipo:&nbsp; <?php echo "<b>".$tipo."</b>" ?>
                                    <br></a><a class="titulos-producto info listado">
                                        Existencias:&nbsp; <?php echo "<b>".$existencias."</b>" ?>
                    </a>
