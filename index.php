...
<section>
    <div class="flexslider">
        <ul class="slides">
            ...
            <li>
                <a href="product.php?action=ver&id=10097">
        ...
        <div class="slider-ts-inner">
            ...
            <div class="slider-ts-item">
                <div class="servicios">
                    ...
                    <a href="/product.php?action=ver&id=10064">
            ...
            <div class="slider-ts-item">
                <div class="servicios">
                    <a href="/nine-blink-182">
                        <section id="serv5" class="servicio">
                            <div class="iconos">
                                <span class="span-lp">LP</span>
                                <img
                    ...
                    <a href="/love-sux-avril-lavigne">
                        <section id="serv6" class="servicio">
                            <div class="iconos">
                                <span class="span-lp">LP</span>
                                <img
                    ...
                    <section id="serv7" class="servicio">
                        <div class="iconos">
                            <span class="span-lp">LP</span>
                    ...
                    <section id="serv8" class="servicio">
                        <div class="iconos">
                            <span class="span-cd">CD</span>
            ...
            <div class="slider-ts-item">
                <div class="servicios">
                    <a href="/nine-blink-182">
                        <section id="serv9" class="servicio">
                            <div class="iconos">
                                <span class="span-cd">CD</span>
                                <img
                    ...
                    <section id="serv10" class="servicio">
                        <div class="iconos">
                            <span class="span-cd">CD</span>
                    ...
                    <section id="serv11" class="servicio">
                        <div class="iconos">
                            <span class="span-boxset">BoxSet</span>
                            <img
                                src="https://is3-ssl.mzstatic.com/image/thumb/Music116/v4/e7/f3/d7/e7f3d7dc-4bf6-e15d-ca28-3105f713e693/192641938573_Cover.jpg/1000x1000.png" />
                        </div>
                        <h3>CRAZY IN LOVE</h3>
                        <h4><span>por</span>ITZY</h4>
                        <h5>MX$1099</h5>
                    </section>
                    <section id="serv12" class="servicio">
                        <div class="iconos">
                            <span class="span-cd">CD</span>
        ...
        <div class="slider-preventas-inner">
            ...
            <div class="slider-preventas-item">
                <div class="servicios">
                    ...
                    <a href="/product.php?action=ver&id=10098">
                        <section id="serv19" class="servicio">
                            <div class="iconos">
                                <span class="span-cd">CD</span>
                                <img
                                    src="https://is4-ssl.mzstatic.com/image/thumb/Music122/v4/59/13/5c/59135ccc-8425-415c-7f89-8aeada60088e/22UM1IM22440.rgb.jpg/500x500.png" />
                            </div>
                            <h3>Midnights</h3>
                            <h4><span>por</span>Taylor Swift</h4>
